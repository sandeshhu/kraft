        ...
        <div className='container mx-auto px-3 md:px-0'>
            <div className='flex flex-col items-center'>
                 {/* <div className='text-center font-mono border px-4 py-1 rounded-2xl w-fit'>
                    <p>We Transform Companies into Recognisable Brands 🚀</p>
                 </div> */}
            ...
            <WrapButton className='mt-5'>
             ...
             <div className=" mx-auto  max-w-6xl mt-10 rounded-[34px] bg-neutral-700">
              <div className="relative z-5 grid w-full gap-8 rounded-[28px] bg-neutral-950">
                <SkiperCard
                  ...
                  description="Whether you’re building dashboards, apps, or landing pages—UI."
                  ...
                  title="⚡️ Supercharge Your Frontend with US."
                />
              </div>
            </div>
